...
PGIE_CLASS_ID_SHUTTER_CLOSE = 0
PGIE_CLASS_ID_SHUTTER_OPEN = 1
...
pgie_classes_str= ["shutter_close" "shutter_open"]
...
def pgie_src_pad_buffer_probe(pad,info,u_data):
    ...
    while l_frame is not None:
        ...
        if not silent:
            ...
            print("Frame Number=", frame_number, "Number of Objects=",num_rects,"Shutter_clone_count=",obj_counter[PGIE_CLASS_ID_SHUTTER_CLOSE], "Shutter_open_count=",obj_counter[PGIE_CLASS_ID_SHUTTER_OPEN])
